...
class Var(object):
    ...
    BIND_ADRESS = str(getenv('WEB_SERVER_BIND_ADDRESS', "10.0.0.4"))
    ...
    if 'DYNO' in environ:
        ...
        ON_HEROKU = False
    FQDN = str(getenv('FQDN', "10.0.0.4:8081")) if not ON_HEROKU or getenv('FQDN',"10.0.0.4:8081") else APP_NAME+'.herokuapp.com'
